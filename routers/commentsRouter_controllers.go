...
func init() {
	...
	beego.GlobalControllerRouter["github.com/lflxp/nmapi/controllers:UserController"] = append(beego.GlobalControllerRouter["github.com/lflxp/nmapi/controllers:UserController"],
		beego.ControllerComments{
			Method: "Post",
			Router: `/`,
			AllowHTTPMethods: []string{"post"},
